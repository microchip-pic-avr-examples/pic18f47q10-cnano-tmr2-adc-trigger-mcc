...
## Demo:
Run the code generated with MCC, LED0 will blink with TMR2 `Timer Period` frequency if Potentiometer value is below a `DesiredThreshold` and will be light ON if above that value. 
